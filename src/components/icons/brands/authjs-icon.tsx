...
export function AuthjsIcon(props: SVGProps<SVGSVGElement> & { color?: string }) {
    ...
    return (
        ...
        >
            ...
            <path
                ...
                fill={color || 'url(#authjs-gradient-1)'}
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                ...
                fill={color || 'url(#authjs-gradient-2)'}
            />
            <path
                ...
                fill={color || 'url(#authjs-gradient-3)'}
                fillOpacity={color ? '1' : '0.21'}
            />
            <ellipse cx="104.905" cy="114.209" rx="47.801" ry="47.4802" fill={color || '#E3E2FA'} />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                ...
                fill={color || 'url(#authjs-gradient-4)'}
            />
        </svg>
    );
}
