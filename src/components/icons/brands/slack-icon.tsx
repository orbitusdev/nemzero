...
export function SlackIcon(props: SVGProps<SVGSVGElement> & { color?: string }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2447.6 2452.5" {...props}>
            <g fillRule="evenodd" clipRule="evenodd">
                <path
                    fill={props.color || '#36c5f0'}
